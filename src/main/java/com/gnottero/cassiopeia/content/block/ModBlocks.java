...
public class ModBlocks {
    ...
    public static final Block BASIC_CONTROLLER = registerBlock("basic_controller",
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, Identifier.fromNamespaceAndPath(Cassiopeia.MOD_ID, name),
                block);
    }
